namespace TestApllication.layout
{
	partial class LoginItem
	{
		...
		#region Getter
		public string UserIdInp
		{
			get
			{
				return txtInpUserId.Text ?? string.Empty;
			}
		}

		public string PasswordInp
		{
			get
			{
				return txtInpPass.Text ?? string.Empty;
			}
		}
		#endregion
		...
		private void InitializeComponent()
		{
			...
			this.txtInpUserId.Name = "txtInpUserId";
